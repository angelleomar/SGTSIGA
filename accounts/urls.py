...
urlpatterns = [
    ...
    # Rutas para las vistas de autenticación proporcionadas por Django
    # Se incluyen las vistas de restablecimiento de contraseña, inicio de sesión y cierre de sesión
    # Estas vistas están disponibles a través de las URL predeterminadas proporcionadas por Django
